...
export const AccountDrop = () => {
	...
	return (
		<>
			<button className="text-white h-full w-[10.5%] font-semibold text-xl  flex items-center justify-center hover:bg-gray-800" onClick={()=>{
			setDrop(!drop)}
			}>My Account</button>
			{drop && <div className="absolute right-[0%] top-[7%] w-[10%] h-1/4 rounded-b-xl  bg-gray-800 text-white grid grid-rows-3 z-10">
